...
def trpPC2():
    """Résolution approchée de y' = 1-y^2 avec y(0) = 0 pour t dans [0,1] avec méthode des trapèzes"""
...
def newt():
    """""Résolution approchée de y' = 1-y^2 avec y(0) = 0 pour t dans [0,1] avec méthode de Newton"""
