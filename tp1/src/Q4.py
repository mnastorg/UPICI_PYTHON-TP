...
def SM2() :
    """Résolution approchée de y' = 1-y^2 avec y(0) = 0 pour t dans [0,1] avec la méthode saute-mouton"""
...
def SM3() :
    """Résolution approchée de y' = 1-y^2 avec y(0) = 2 pour t dans [0,1] avec la méthode saute-mouton"""
